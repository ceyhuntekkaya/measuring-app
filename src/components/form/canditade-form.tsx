        ...
        <Card>
            ...
            <CardContent>
                <div className="space-y-6">
                    {/* Kimlik Bilgileri */}
                    <div>
                        <h3 className="text-lg font-medium text-gray-900 mb-4">Kimlik Bilgileri</h3>
                    ...
                    {(formData.name && formData.lastName && formData.identityNumber) && (
                        <div className="bg-gray-50 p-4 rounded-lg">
                            ...
                            <div className="grid grid-cols-2 gap-4 text-sm text-gray-600">
                                <div>
                                    <span className="font-medium">Ad Soyad:</span> {formData.name} {formData.lastName}
                                </div>
                                <div>
                                ...
                                {formData.city && formData.country && (
                                    <div>
                                        <span className="font-medium">Lokasyon:</span> {formData.city}, {formData.country}
                                    </div>
                                )}
                            </div>
                        </div>
