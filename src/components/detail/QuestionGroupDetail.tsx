...
const QuestionGroupDetail: React.FC<QuestionGroupDetailProps> = ({ selectedQuestionGroup }) => {
        ...
        <div className="mx-auto p-6 space-y-6">
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    <div>
                                        ...
                                        <div className="text-blue-900 font-semibold text-sm">
                                            {getExamTypeLabel(selectedQuestionGroup.examType.examType)}
                                        </div>
                                    </div>
                                    <div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6 border border-gray-200">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {selectedQuestionGroup.createdById && (
                        <div className="p-4 bg-gray-50 rounded-lg">
                            <div className="text-sm font-medium text-gray-500">Oluşturan Kullanıcı ID</div>
                            <div className="text-gray-900 font-mono">{selectedQuestionGroup.createdById}</div>
                        </div>
                    )}

                    {selectedQuestionGroup.deletedAt && (
                        <div className="p-4 bg-red-50 rounded-lg border border-red-200">
                            <div className="text-sm font-medium text-red-600">Silinme Tarihi</div>
                            <div className="text-red-900 font-semibold">
                                {new Date(selectedQuestionGroup.deletedAt).toLocaleDateString('tr-TR', {
                                    year: 'numeric',
                                    month: 'long',
                                    day: 'numeric',
                                    hour: '2-digit',
                            ...
                            {selectedQuestionGroup.deletedById && (
                                <div className="text-xs text-red-600 mt-1">
                                    Silen: {selectedQuestionGroup.deletedById}
                                </div>
                            )}
                        </div>
                    )}
