                ...
                <div className="flex items-center gap-4 flex-1">
                    <div className="w-12 h-12 rounded-full overflow-hidden bg-gray-200 flex-shrink-0">
                        {participant.candidatePhotoUrl ? (
                            <img src={participant.candidatePhotoUrl} alt={participant.candidateName} className="w-full h-full object-cover"/>
                        ) : (
                            <div
                                className="w-full h-full flex items-center justify-center text-gray-500 text-xl font-semibold">
                    ...
                    <div className="flex-1 min-w-0">
                        <h3 className="font-semibold text-gray-900 truncate">{participant.candidateName} {participant.candidateLastName}</h3>
                        ...
                        <>
                            ...
                            {participant.sessionState === ESessionState.IN_PROGRESS && (
                                <div className="text-sm">
                                    ...
                                    <div
                                        className="font-medium">participant.currentQuestion/participant.totalQuestions</div>
                                </div>
                            )}
...
const ExamParticipants: React.FC<ExamTypeFormProps> = ({
                                                           candidates
                                                       }) => {
